...
def main(unused_argv):
  ...
  for idx in range(dataset.size):
    ...
    time.sleep(3)
    utils.save_img_u8(rendering['R'], path_fn(f'light_{idx:03d}.png'))
    

    # time.sleep(3)
    # utils.save_img_u8(rendering['obj'], path_fn(f'anti_obj_{idx:03d}.png'))
    # time.sleep(3)
    # utils.save_img_u8(1.0 - rendering['obj'], path_fn(f'obj_{idx:03d}.png'))
    # time.sleep(3)
